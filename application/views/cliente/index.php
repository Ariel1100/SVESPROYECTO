...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <ul class="nav nav-lg nav-tabs nav-left no-margin no-border-radius   border-top border-top-indigo-100">
            <li class=" active">
                <a href="#messages-tue" class="viuno text-size-small text-uppercase bg-gray-100 text-black" data-toggle="tab">
                    Lista Clientes
                </a>
            </li>

            <li class='' id=''>
                <a href="#messages-mon" class="vidos text-size-small text-uppercase bg-gray-100 text-black" data-toggle="tab">
                    agregar Cliente
                </a>
            </li>
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" action="" name="FormDatos" id="FormDatos" method="POST">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group has-feedback has-feedback-left">
                                                    <input type="text" class="form-control input-lg"
                                                        ...
                                                        name="txtPrimerApellido" required="required">
                                                    <div class="form-control-feedback">
                                                ...
                                                <div class="form-group has-feedback has-feedback-left">
                                                    <input type="alpha-numeric" class="form-control"
                                                        ...
                                                        name="txtCarnetIdentidad" required="required">
                                                    <div class="form-control-feedback">
                                                ...
                                                <div class="form-group has-feedback has-feedback-left">
                                                    <input type="text" class="form-control input-lg" placeholder="Sexo"
                                                        id="txtSexo" name="txtSexo" required="required">
                                                    <div class="form-control-feedback">
                                                        <i class="icon-spam"></i>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group has-feedback has-feedback-left">
                                                    <input type="number" class="form-control"
                                                        ...
                                                        name="txtTelefono" required="required">
                                                    <div class="form-control-feedback">
                            ...
                            <div class="text-right">
                                <a class="btn btn-info" id="btnCancelarE" href="<?php echo base_url();?>cliente"
...
<!-- <script>
    ...
    if(via){
        ...
        const uno = document.querySelector('.viuno');
        const dos = document.querySelector('.vidos');
        console.log(dos);
        dos.ariaExpandend=true;
