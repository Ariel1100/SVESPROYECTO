...
if ($this->uri->segment(1)=='reporte') {?> 
	<script type="text/javascript" src="<?php echo base_url(); ?>/js/reporte.js"></script><?php }
if ($this->uri->segment(1)=='reportep') {?> 
	<script type="text/javascript" src="<?php echo base_url(); ?>/js/reportep.js"></script><?php }
