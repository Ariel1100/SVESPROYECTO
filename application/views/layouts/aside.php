                    ...
                    <div class="sidebar-category sidebar-category-visible">
                        <div class="category-content no-padding">
                            <ul class="navigation navigation-main navigation-accordion">
                                ...
                                <li ><a href="<?php echo base_url(); ?>tablero"><i class="icon-home4"></i> <span>Inicio</span></a></li>
                                <?php if ($this->session->userdata('tipo')=='1') {?>
                                <li>
                                ...
                                <?php if ($this->session->userdata('tipo')=='1') {?>
                                <li>
                                    <a href="#"><i class="icon-file-pdf"></i> <span>Reportes</span></a>
                                    <ul>
                                        <li><a href="<?php echo base_url(); ?>reporte">Reportes ventas</a></li>
                                    </ul>
                                    <ul>
                                        <li><a href="<?php echo base_url(); ?>reportep">Reportes Productos</a></li>
                                    </ul>
                                </li>
                                <?php } ?>
            ...
            <div class="content-wrapper">
                ...
                <div class="page-header page-header-default">
                    ...
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            <li><a href="#"><i class="icon-home2 position-left"></i> SVES</a></li>
                            <li class="active">Sistema de Ventas</li>
                        </ul>
